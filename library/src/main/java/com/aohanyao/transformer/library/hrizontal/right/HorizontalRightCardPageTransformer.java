package com.aohanyao.transformer.library.hrizontal.right;
 ...
 * 水平滑动的
 */
public class HorizontalRightCardPageTransformer implements ViewPager.PageTransformer {
    /**
     * 偏移量
     */
     ...
     */
    public HorizontalRightCardPageTransformer(int mScaleOffset) {
